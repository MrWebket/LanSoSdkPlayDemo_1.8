...
import com.lansosdk.playdemo.util.AndroidDevices;
import com.lansosdk.playdemo.util.LanSoDemoApplication;
import com.lansosdk.playdemo.util.SlidingLayer;
...
//    }
    ...
    public void onVideoSizeChanged(MediaPlayer mediaplayer, int width,
    		int height, int visibleWidth, int visibleHeight, int sarNum,
    		int sarDen) {
    	// TODO Auto-generated method stub
        if (width * height == 0)
            return;
...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    private void startPlayback(boolean isSwCodec) {
      ...
      if (mUri != null) 
      {
      	  	...
      	  	mMediaPlayer.setDataSource(mUri,isSwCodec);  //<-----------------set data source
